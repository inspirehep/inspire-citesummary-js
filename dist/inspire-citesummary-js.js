...
(function (angular) {
  ...
  var citeSummary = angular.module("citeSummary", [
    'citeSummary.services',
    'citeSummary.directives'
  ]);
...
/**
 * Created by eamonnmaguire on 19/10/2016.
 */
/*!
 *  dc 2.1.0-dev
...
/**
 ...
 chart.legend(dc.legend().x(400).y(10).itemHeight(13).gap(5))
 ```
 From http://jsfiddle.net/za8ksj45/39/
...
dc.legend2 = function () {
    ...
    _legend.render = function () {
        ...
        itemEnter.append('text')
            .text(function (d) {
                ...
                if (_showPercent) {
                    var groupTotal = d.chart.group().all().reduce(function (a, v) {
                        return a + v.value;
                    }, 0);
    ...
    // Nico Hofmeester  additions to original legend.js file from dc.js-2.0.0-beta.5\src
    //   - Add functionality to show (%) as part of the legend
    /**
     #### .showPercent([value])
     legendItem show (%) as part of text. Default: false
     **/
    _legend.showPercent = function (_) {
        if (!arguments.length) {
            return _showPercent;
        }
        _showPercent = _;
    ...
    /**
     #### .percentDecimals([value])
     number of decimals in the (%) number formatting.  Default: 1
     **/
    _legend.percentDecimals = function (_) {
        if (!arguments.length) {
            return _percentDecimals;
        }
        _percentDecimals = _;
        return _legend;
    };
