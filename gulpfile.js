...
gulp.task('build.src', function () {
    gulp.src(sourceFiles)
        ...
        .pipe(plugins.concat('inspire-citesummary-js.js'))
        .pipe(plugins.header(licences.javascript))
        .pipe(gulp.dest('./dist/'))
        .pipe(plugins.uglify())
        .pipe(plugins.rename('inspire-citesummary-js.min.js'))
        .pipe(plugins.header(licences.javascript))
        .pipe(gulp.dest('./dist'));
});
...
gulp.task('build.templates', function() {
    gulp.src(templates, {cwd: sourceDirectory})
        .pipe(gulp.dest('./dist/'));
});
...
gulp.task('watch', function () {
    ...
    gulp.watch(sourceFiles, ['clean.build', 'build']);
});
